...
Required environment variables:
  ...
  AGENT_NAME                 – Display name for the agent (default: petstoresupplychain-orchestrator-agent)
...
def main():
    ...
    agent_name = os.environ.get("AGENT_NAME", "petstoresupplychain-orchestrator-agent")
    ...
    system_prompt = "You are a petstore supply chain operations assistant."
