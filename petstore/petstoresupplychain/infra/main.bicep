// ─────────────────────────────────────────────────────────────
// PetStore Supply Chain – Main Bicep Deployment
...
param baseName string = 'petstoresupplychain'

@description('Foundry account display name')
param foundryAccountName string = '${baseName}-foundry'

@description('Foundry project name')
param foundryProjectName string = '${baseName}-foundryproject'
...
param acrName string = '${replace(baseName, '-', '')}acr${uniqueString(resourceGroup().id)}'
